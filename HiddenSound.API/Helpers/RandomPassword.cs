...
namespace HiddenSound.API.Helpers
{
    ...
    public class RandomPassword
    {
        ...
        /// Randomly generated password.
        /// </returns>
        public static string Generate(int length, bool lowerCase = true, bool upperCase = true, bool numeric = true, bool special = true)
        {
            return Generate(length, length, lowerCase, upperCase, numeric, special);
        }
        ...
        /// function parameters.
        /// </remarks>
        public static string Generate(int minLength, int maxLength, bool lowerCase = true, bool upperCase = true, bool numeric = true, bool special = true)
        {
            ...
            if (lowerCase)
            {
                charGroups.Add(PASSWORD_CHARS_LCASE.ToCharArray());
            }
            if (upperCase)
            {
                charGroups.Add(PASSWORD_CHARS_UCASE.ToCharArray());
            }
            if (numeric)
            {
